...
public class ChangeChildTags : MonoBehaviour {     // TO USE THIS COOL FEATURE: select your game object, give it a tag (like "terrain" to avoid sensors) and open gameobject menu on top left side of unity. Thes click "Change child tag to parent tag". this is gona apply the tag to every child and sub-child object
