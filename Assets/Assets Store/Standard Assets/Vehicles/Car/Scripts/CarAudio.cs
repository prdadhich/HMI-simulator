...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAudio : MonoBehaviour
    {
        ...
        [Header("Wheel Sounds")]                                                           //the title of the section on the component
        ...
        //New audio source
        [Header("Sound FX")]                                                           //the title of the section on the component
        public AudioClip overSpeedingClip;                                             
        public AudioClip safetyDistanceClip;                                            
        public AudioClip emergencyBrakeClip;                                         
        //public AudioClip xxxClip; 
        ...
        //new fx
        private AudioSource m_OverSpeeding;    // Source for the low acceleration sounds
        private AudioSource m_SafetyDistance;  // Source for the low deceleration sounds
        private AudioSource m_EmergencyBrake;  // Source for the high acceleration sounds
        //private AudioSource m_xxx;     // Source for the high deceleration sounds
        ...
        private void StartSound()
        {
            ...
            if (engineSoundStyle == EngineAudioOptions.FourChannel)
            {
                ...
                // nex FX
                m_OverSpeeding = SetUpEngineAudioSource(overSpeedingClip);
                m_SafetyDistance = SetUpEngineAudioSource(safetyDistanceClip);
                m_EmergencyBrake = SetUpEngineAudioSource(emergencyBrakeClip);
            }
        ...
        private void Update()
        {
            ...
            //Debug.Log(Camera.main.transform.position); // to find the main camera of the game
